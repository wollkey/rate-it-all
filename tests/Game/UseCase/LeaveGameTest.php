...
final class LeaveGameTest extends KernelTestCase
{
    private LeaveGameUseCase $useCase;
    ...
    {
        $this->useCase = self::getContainer()->get(LeaveGameUseCase::class);
    ...
    public function testPlayerLeaved(): void
    {
        ...
        self::assertCount(1, $this->game->getPlayers());
        self::assertFalse($this->game->getPlayers()->contains($player));
    }
